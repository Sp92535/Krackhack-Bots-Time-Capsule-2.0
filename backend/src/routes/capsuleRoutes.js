...
import { createCapsule, deleteCapsule, getAllPublicCapsules, getUserCapsules, lockCapsule, updateCapsule, uploadCapsuleData } from "../controllers/capsuleController.js";
...
router.get("/all-capsules", getAllPublicCapsules);
